...
export default function ContentPage({
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      {/* Table of Contents — only show when sections have content or no articles exist */}
      {(articles.length === 0 || sections.some((s) => s.content || s.videoPlaceholder || s.audioPlaceholder || s.imagePlaceholder)) && (
      ...
      {/* Content Sections — only show sections that have content */}
      <div className="space-y-12">
        {sections.map((section, i) => {
          const hasContent = section.content || section.videoPlaceholder || section.audioPlaceholder || section.imagePlaceholder;
          // Skip placeholder sections when articles exist
          if (!hasContent && articles.length > 0) return null;
